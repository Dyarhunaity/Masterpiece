...
?>
	...
	<section id="home" class="no-padding">	
    	<div id="main-slide" class="cd-hero">
			<ul class="cd-hero-slider">
				<li class="selected">
					<div class="overlay2">
						<img class="" src="https://www.touristjordan.com/wp-content/uploads/2019/02/The-Red-Sea-in-Jordan-2-1024x576.jpg" alt="slider">
					</div>
					<div class="cd-full-width">
						<h2>Explore The Finest Places in Aqaba</h2>
						<h3>We are glad to make your experience better</h3>
				...
				<li>
					<div class="overlay2">
						<img class="" src="https://theblondeabroad.com/wp-content/uploads/2020/01/Deep-Blue-TBAEscapes-Group-2019-090455_%C2%A9DomLeeZaax-2.jpg" alt="slider">
					</div>
					<div class="cd-half-width">
						<h2>How Big Can You Dream?</h2>
						<p>Dive in To Check Out Our Most Visited Sites in Aqaba</p>
						<a href="#0" class="cd-btn btn btn-primary solid">Take a Tour</a>
					</div> <!-- .cd-half-width -->

					<div class="cd-half-width cd-img-container">
						<img src="https://ekodivers.com/wp-content/uploads/2017/09/OWD-diver.png" alt="">                         <!--Slider Img-->
					</div> <!-- .cd-half-width.cd-img-container -->
				</li>
				<li>
					<div class="overlay2">
						<img class="" src="https://talabay.net/wp-content/uploads/2016/05/View-from-top.jpg" alt="slider">
					</div>
					<div class="cd-half-width cd-img-container img-right">
						<img src="https://www.deepbluedivecenter.com/wp-content/uploads/Map-jordan-01-2-901x1024-1.png" alt="">
					</div> <!-- .cd-half-width.cd-img-container -->
					<div class="cd-half-width">
						<h2>Your Challenge is Our Progress</h2>
						<p>Enjoyed Your Visit in Aqaba? How about You Give It Another Try To Learn 
							More Intresting Facts about This Beautiful City
						</p>
		...
		<div class="cd-slider-nav">
			<nav>
				...
				<ul>
					 <li class="selected"><a href="#0"><i class="fa fa-bicycle"></i> Explore</a></li>
					<li><a href="#0"><i class="fa fa-lightbulb-o"></i> Complete</a></li>
					<li><a href="#0"><i class="fa fa-diamond"></i> Repeat</a></li>
				...
				<div class="col-md-12">
					<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay=".5s">
						<div class="service-content text-center">
							...
							<p>Available round-the-clock, your personal concierge will handle all the details.</p>
						</div>
					</div><!--/ End first service -->

					<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay=".8s" >
						<div class="service-content text-center">
							<span class="service-icon icon-pentagon"><i class="fa fa-street-view"></i></span>
							<h3>Diverse destinations</h3>
							<p>there is potentially a much more impactful upside to diverse travel. And when we state “diverse,” we mean it in every possible sense.</p>
						</div>
					...
					<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay="1.1s">
						<div class="service-content text-center">
							<span class="service-icon icon-pentagon"><i class="fa fa-angle-double-down"></i></span>
							<h3>Beautiful places</h3>
							<p>See with your own eyes our most beautiful sites</p>
						</div>
					</div><!--/ End Third service -->

					<div class="col-md-3 col-sm-3 wow fadeInDown" data-wow-delay="1.4s">
						<div class="service-content text-center">
							<span class="service-icon icon-pentagon"><i class="fa fa-envelope-o"></i></span>
							<h3>Instant help</h3>
							<p>Call for help and tell us what the problem is </p>
						</div>
					</div><!--/ End 4th service -->
				</div>
			</div><!-- Content row end -->
	...
	<section id="portfolio" class="portfolio">
		<div class="container">
			<div class="row">
				<div class="col-md-12 heading">
					<span class="title-icon classic pull-left"><i class="fa fa-heart-o"></i></span>
					<h2 class="title classic">Our Aqaba</h2>
				</div>
			</div> <!-- Title row end -->
			...
			<div class="row text-right">
				<div class="isotope-nav" data-isotope-nav="isotope">
					<ul>
						...
						<li><a href="#" data-filter=".web-design">Activities</a></li>
						<li><a href="#" data-filter=".development">Tours</a></li>
						<li><a href="#" data-filter=".joomla">Hotels</a></li>
						<li><a href="#" data-filter=".wordpress">Resturants</a></li>
					</ul>
				</div>
			...
			<div class="row">
				<div id="isotope" class="isotope">
					<div class="col-sm-3 web-design isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://aqaba-diving.com/wp-content/uploads/2019/11/Flyboard-in-Aqaba.jpg" style="height: 350px;" alt="">
								<figcaption>
									<h3>Flyboard</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://aqaba-diving.com/wp-content/uploads/2019/11/Flyboard-in-Aqaba.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>			
							</figure>
						</div>
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="http://stepintojordan.com/wp-content/uploads/2019/09/Jordan-Petra-Siq-and-Treasury-Entrance.jpg" style="height:350px;" alt="">
								<figcaption>
									<h3>Petra</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="http://stepintojordan.com/wp-content/uploads/2019/09/Jordan-Petra-Siq-and-Treasury-Entrance.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>				
							</figure>
						</div>
					</div><!-- Isotope item end -->
					...
					<div class="col-sm-3 joomla isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://assets.hyatt.com/content/dam/hyatt/hyattdam/images/2018/11/29/1013/Hyatt-Regency-Aqaba-P043-Exterior-Aerial-Hero.jpg/Hyatt-Regency-Aqaba-P043-Exterior-Aerial-Hero.16x9.jpg" style="height:350px;" alt="">
								<figcaption>
									<h3>Hyatt Regency</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://assets.hyatt.com/content/dam/hyatt/hyattdam/images/2018/11/29/1013/Hyatt-Regency-Aqaba-P043-Exterior-Aerial-Hero.jpg/Hyatt-Regency-Aqaba-P043-Exterior-Aerial-Hero.16x9.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>				
							</figure>
						</div>
					</div><!-- Isotope item end -->
					...
					<div class="col-sm-3 wordpress isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://media-cdn.tripadvisor.com/media/photo-s/0e/cc/f5/38/apsara-restaurant.jpg" style="height:350px;" alt="">
								<figcaption>
									<h3>Apsara</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://media-cdn.tripadvisor.com/media/photo-s/0e/cc/f5/38/apsara-restaurant.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div><!-- Isotope item end -->
					...
					<div class="col-sm-3 joomla isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://imgcy.trivago.com/c_lfill,d_dummy.jpeg,e_sharpen:60,f_auto,h_450,q_auto,w_450/itemimages/97/39/97398_v2.jpeg" style="height:350px;" alt="">
								<figcaption>
									<h3>Movenpick</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://imgcy.trivago.com/c_lfill,d_dummy.jpeg,e_sharpen:60,f_auto,h_450,q_auto,w_450/itemimages/97/39/97398_v2.jpeg"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div><!-- Isotope item end -->
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://wonderstourism.com/wp-content/uploads/2013/02/wadi_rum-sunset.jpg" style="height:350px;" alt="">
								<figcaption>
									<h3>Wadi Rum</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://wonderstourism.com/wp-content/uploads/2013/02/wadi_rum-sunset.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div><!-- Isotope item end -->
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://www.globeguide.ca/wp-content/uploads/2019/10/Jordan-Aqaba-red-sea-boat-2.jpg" style="height:350px ;" alt="">
								<figcaption>
									<h3>Red Sea</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://www.globeguide.ca/wp-content/uploads/2019/10/Jordan-Aqaba-red-sea-boat-2.jpg"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div><!-- Isotope item end -->
					...
					<div class="col-sm-3 development isotope-item">
						<div class="grid">
							<figure class="effect-oscar">
								<img src="https://i0.wp.com/www.touristisrael.com/wp-content/uploads/2020/11/shutterstock_612456992-scaled.jpg?fit=2560%2C1649&ssl=1" style="height:350px;" alt="">
								<figcaption>
									<h3>Explore Aqaba</h3>
									<a class="link icon-pentagon" href="portfolio-item.html"><i class="fa fa-link"></i></a>
									<a class="view icon-pentagon" data-rel="prettyPhoto" href="https://i0.wp.com/www.touristisrael.com/wp-content/uploads/2020/11/shutterstock_612456992-scaled.jpg?fit=2560%2C1649&ssl=1"><i class="fa fa-search"></i></a>            
								</figcaption>					
							</figure>
						</div>
					</div><!-- Isotope item end -->
		...
		<div class="container">
			<div class="row">
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						...
						<p>In our website,you will have unlimited updates so you can check out more places in aqaba.</p>
					</div>
				...
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						<h3>Total Control</h3>
						<p>Have your own Control without being interrupted.</p>
					</div>
				...
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						<h3>Free Without Charges</h3>
						<p>Pick your wanted destination without paying anything!</p>
					</div>
			...
			<div class="row">
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						<h3>Support Team</h3>
						<p>If you have any problems while picking a destination,ask for help from our support team.</p>
					</div>
				...
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						...
						<p>We hope to keep you safe with our best security systems</p>
					</div>
				</div><!--/ End 2nd featurebox -->

				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					<span class="feature-icon pull-left" ><i class="fa fa-sliders"></i></span>
					<div class="feature-content">
						<h3>Better Performance</h3>
						<p>we guarantee our customers the best Performance from our website </p>
					</div>
				</div><!--/ End 3rd featurebox -->
			...
			<div class="row">
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						...
						<p>We guarantee you to be satisfied by our best services we give.</p>
					</div>
				</div><!--/ End first featurebox -->
				...
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						...
						<p>Our website is fully licensed so all Intellectual Property rights owned or purported to be owned by a third party and licensed to the Company  </p>
					</div>
				</div><!--/ End first featurebox -->
				...
				<div class="feature-box col-sm-4 wow fadeInDown" data-wow-delay=".5s">
					...
					<div class="feature-content">
						<h3>knowledgeable local sites</h3>
						<p>Our guides and local sites are </p>
					</div>
				</div><!--/ End first featurebox -->
			</div><!-- Content row end -->
			...
			<div class="row">
				...
				<div class="col-md-6 ts-padding img-block-right">
					<div class="img-block-head text-center">
						<h2>Know More About Aqaba</h2>
						<h3>Why Choose Aqaba</h3>
