...
<form style="margin:400px; margin-top:85px;margin-bottom: 1px;" action="login.php" method="POST" id="logForm">
    ...
    <button class="btn col-md-2 offset-md-4" type="submit" name="login" style="background-color:#363062 ; color:#E9D5DA; margin:50px">LOG IN</button>
    <br><br>
<!-- End Log In form -->
...
<button class="btn col-md-2 offset-md-4" type="submit" name="switch" style="background-color:#E9D5DA ; color:#363062;width:75px;"><a href="./register.php">Sign Up </a></button>
<a style="color:blue;" class="btn col-md-2 offset-md-4" href="reset.php">Forget password?</a>
</form>
