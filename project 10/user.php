                                ...
                                <div class="card-body">
                                    <form action="user.php" method="post">
                                        ...
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label style="margin-right:250px;" for="ciTy">Country</label>
