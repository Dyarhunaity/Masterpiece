<?php 
    ...
    if(isset($_POST['add_to_cart']) && $_POST['add_to_cart'] == 'add to cart')
    {
        ...
        $img2=$fetchProduct['image2'];
        $img3=$fetchProduct['image3'];
        ...
        $cartArray = [
            ...
            'product_img' =>$fetchProduct['image2'],
            'product_img' =>$fetchProduct['image3']
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <img src="<?php echo $product[0]['image']; ?>" class="rounded img-thumbnail mr-2" style="width:40px;"><?php echo $product[0]['pname']?> is added to your faviorate. <a href="cart.php" class="alert-link">View favoriates</a>
                    </div>
                </div>
            </div>
         <?php }?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="img">
                                <figure><img style="height:500px; width:500px; " src="<?php echo $product[0]['image']; ?>" alt="product" /></figure>
  ...
  padding: 5px;
                     ...
                     <i class="fa fa-star-o" aria-hidden="true"></i>
                                ...
                                <div class="detail-contant">
                                    <p style="font-size:15px; color:black;"><?php echo $product[0]['description']; ?>
                                        <br>
                                    </p>
                                    <form class="form-inline" method="POST">
                    <div class="form-group mb-2  ">
                        <input style="display:none;" type="number" name="product_qty" id="productQty" class="form-control-md" placeholder="Quantity" min="1" max="1000" value="1">
                        <input type="hidden" name="product_id" value="<?php echo $product[0]['id'];?>" style="">
                    </div>
                    <div class="form-group mb-2 ml-2">
                        <button type="submit" class="btn btn-success" name="add_to_cart" value="add to cart">Add to Faviorate</button>
                    </div>
                </form>
                                </div>
                            </div>
                            ...
                            <div class="full">
                                <div class="tab_bar_section">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#Gallery">Gallery</a> </li>
                                    ...
                                    <div class="tab-content">
                                        <div id="Gallery" class="tab-pane active">
                                            <div class="row">
                                            <div class="row">
                                            <figure><img style="height:400px; width: 600px;" src="<?php echo $product[0]['image2']  ?>" alt="product"/></figure>    
                                            </div>       
                                             
                                            <div style="margin-top:-5px;" class="column">                          
                                           <figure><img style="height:400px; width: 600px;" src="<?php echo $product[0]['image3']  ?>" alt="product"/></figure>
                                           </div>         
                                                            ...
                                                            <div id="collapseExample" class="full collapse commant_box">
                                                                ...
                                                                <input type='hidden' name='product_id' value='<?php echo $product_id; ?>'>
                                                                    ...
                                                                    <div class="full_bt center">
                                                                        <button class="bt_main" type="submit" name="CommentSubmit">Send</button>
                                                                    </div>
                                                                </form>
                                                            </div>
